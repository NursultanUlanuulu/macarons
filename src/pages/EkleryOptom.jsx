    ...
    <div>
      <div className={style.firstPage}>
        ...
        <div>
          <h1>Эклеры оптом</h1>
          <p>
            Макаруны оптом от производителя, а также эклеры, пирожное картошка,
            кейк-посы, леденцовая карамель, маффины, орешки со сгущенкой и
            вафельные трубочки. Наши пирожные продаются в крупнейших
            кондитерских и кофейных сетях Санкт-Петербурга и Москвы. Они хорошо
            узнаваемы, что позволяют делать высокую наценку, и имеют более 75%
            повторных покупок.
          </p>
