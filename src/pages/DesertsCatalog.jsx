            ...
            <div className={style.catalogBlock}>
                ...
                <div className={style.catalog}>
                    <div className={style.pirojnyiMakaron}>
                        <div> <img src={catalog} alt="" /> </div>
                    </div>
                    <div className={style.pirojnyiMakaronText}>
                        <h1>Пирожные макарон</h1>
                        <p className={style.dscr}>Самые классные, самые лучшие, свежие, воздушные, хрустящие макарушки. лучшее, что мы умеем делать.</p>
                        <Link to='/podarochnye_nabory'><button className={style.btn}> Подарочные наборы</button></Link>
                ...
                <h1 className={style.textH1}>Хотите попробовать<br /> всё сразу? </h1>
