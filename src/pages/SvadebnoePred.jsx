...
const SvadebnoePred = () => {
	...
	return (
		...
		<div style={{ backgroundColor: '#F6F6F6' }}>
				...
				<div className={styles.textMain}>
					...
					<ul className={styles.ul}>
						...
						<li>
							...
							оппозиции, превозмогая сложившуюся непростую экономическую
							ситуацию, смешаны с не уникальными данными до степени совершенной
			...
			{/* //block-2  */}
			<h2 style={{ textAlign: 'center', fontSize: '30px', marginTop: '49px' }}>
				Наборы для свадьбы
			</h2>
			...
			<div>
				...
				<div className={styles.text}>
					...
					<h5>
						...
						решения для Вашего мероптиятия
					</h5>
					<span>
					...
					<p>
						...
						оферты и разрешаю обработку моих персональных данных в соответствии
			...
			<div className={styles.block4}>
				...
				<div className={styles.faq}>
					...
					<p>
						Стандартный срок выполнения заказа 3-5 дней, При большом тираже и в
						предновогодний сезон может увеличиться. Потому что...
					</p>
				</div>
				<div className={styles.faq}>
					<h3>А за 2 дня?</h3>
